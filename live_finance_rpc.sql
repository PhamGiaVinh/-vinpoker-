-- VERBATIM dump of the LIVE public.get_club_finance_summary (pg_get_functiondef output),
-- provided by the owner from project orlesggcjamwuknxwcpk. This is the BASELINE that P6
-- (20261111000006_finance_summary_fnb.sql) clones byte-faithful. DO NOT edit this file.
-- Live version = staking (fixed/percent/archive) + payout fees + CONFIGURED rake (online/offline/
-- reentry, free-rake on online) + service fee + reconciliation; super_admin via user_roles; NO pt-wage.
