...
export const floorButtonCoverageManifest: readonly FloorButtonCoverageEntry[] = [
  ...
  { id: "clock-adjust", route: "/ops/tournaments/:id", role: "floor", viewport: all, label: "1 phút", expectedState: "enabled", expectedBackendCall: "tournament-live-clock(adjust_time)", expectedDbInvariant: "clock adjustment stays in the owned tournament", fixtureScenario: "SETUP_CLOCK", destructive: true },
