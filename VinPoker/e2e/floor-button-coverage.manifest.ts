...
export const floorButtonCoverageManifest: readonly FloorButtonCoverageEntry[] = [
  ...
  { id: "tables-open-dialog", route: "/ops/tables", role: "floor", viewport: all, label: "Bàn", testId: "floor-open-table-dialog", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "tables-open-number", route: "/ops/tables", role: "floor", viewport: all, label: "Số bàn", testId: "floor-table-number-option", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "tables-open-mode-manual", route: "/ops/tables", role: "floor", viewport: all, label: "Manual Floor", testId: "floor-open-mode-manual", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "tables-open-mode-tracker", route: "/ops/tables", role: "floor", viewport: all, label: "Live Tracker", testId: "floor-open-mode-tracker", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "tables-open-filter-all", route: "/ops/tables", role: "floor", viewport: all, label: "Tất cả", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "tables-open-filter-available", route: "/ops/tables", role: "floor", viewport: all, label: "Có thể mở", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "tables-open-filter-closed", route: "/ops/tables", role: "floor", viewport: all, label: "Đã đóng", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "tables-open-retry", route: "/ops/tables", role: "floor", viewport: all, label: "Tải lại", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "tables-open", route: "/ops/tables", role: "floor", viewport: all, label: "Mở bàn", testId: "floor-open-table-confirm", expectedState: "enabled", expectedBackendCall: "floor_open_tournament_table_v2", expectedDbInvariant: "owned TABLE_LIFECYCLE table number 1-100, nine seats, and control mode commit atomically without payout", fixtureScenario: "TABLE_LIFECYCLE", destructive: true },
  { id: "floor-open-dialog", route: "/floor", role: "floor", viewport: all, label: "Mở bàn", testId: "floor-open-table-dialog", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "floor-open-number", route: "/floor", role: "floor", viewport: all, label: "Số bàn", testId: "floor-table-number-option", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "floor-open-mode-manual", route: "/floor", role: "floor", viewport: all, label: "Manual Floor", testId: "floor-open-mode-manual", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "floor-open-mode-tracker", route: "/floor", role: "floor", viewport: all, label: "Live Tracker", testId: "floor-open-mode-tracker", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "floor-open-filter-all", route: "/floor", role: "floor", viewport: all, label: "Tất cả", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "floor-open-filter-available", route: "/floor", role: "floor", viewport: all, label: "Có thể mở", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "floor-open-filter-closed", route: "/floor", role: "floor", viewport: all, label: "Đã đóng", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "floor-open-retry", route: "/floor", role: "floor", viewport: all, label: "Tải lại", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "TABLE_LIFECYCLE", destructive: false },
  { id: "floor-open", route: "/floor", role: "floor", viewport: all, label: "Mở bàn", testId: "floor-open-table-confirm", expectedState: "enabled", expectedBackendCall: "floor_open_tournament_table_v2", expectedDbInvariant: "owned TABLE_LIFECYCLE table number 1-100, nine seats, and control mode commit atomically without payout", fixtureScenario: "TABLE_LIFECYCLE", destructive: true },
  { id: "floor-v3-select-entry-group", route: "/floor", role: "floor", viewport: all, label: "Chưa có ghế / Đã loại", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "BUST_RESTORE", destructive: false },
  { id: "floor-v3-select-entry", route: "/floor", role: "floor", viewport: all, label: "Chọn entry theo ID", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "BUST_RESTORE", destructive: false },
  { id: "floor-v3-add-player", route: "/floor", role: "floor", viewport: all, label: "Thêm vào ghế này", expectedState: "enabled", expectedBackendCall: "floor_assign_entry_to_seat", expectedDbInvariant: "one eligible entry occupies one owned active V3 seat by entry ID", fixtureScenario: "TABLE_LIFECYCLE", destructive: true },
  { id: "floor-v3-restore-player", route: "/floor", role: "floor", viewport: all, label: "Khôi phục vào ghế này", expectedState: "enabled", expectedBackendCall: "floor_restore_busted_player_to_seat_v3", expectedDbInvariant: "one busted entry is restored to one active V3 seat without payout", fixtureScenario: "BUST_RESTORE", destructive: true },
  { id: "floor-v3-open-bust", route: "/floor", role: "floor", viewport: all, label: "Mở xác nhận loại", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "BUST_RESTORE", destructive: false },
  { id: "floor-v3-open-free-sit", route: "/floor", role: "floor", viewport: all, label: "Free Sit", expectedState: "disabled", expectedBackendCall: null, expectedDbInvariant: "entry and stack remain unchanged while the seat is released", fixtureScenario: "BUST_RESTORE", destructive: true, exclusionReason: "floorFreeSitV1 remains false until the owner-gated migration and authenticated UAT pass." },
  { id: "floor-v3-free-sit-confirm", route: "/floor", role: "floor", viewport: all, label: "Confirm Free Sit", expectedState: "disabled", expectedBackendCall: null, expectedDbInvariant: "entry returns to Waiting with the exact current stack and no payout", fixtureScenario: "BUST_RESTORE", destructive: true, exclusionReason: "floorFreeSitV1 remains false until the owner-gated migration and authenticated UAT pass." },
  { id: "floor-v3-bust-confirm", route: "/floor", role: "floor", viewport: all, label: "Xác nhận loại", expectedState: "enabled", expectedBackendCall: "floor_bust_player_v3", expectedDbInvariant: "only the selected entry is busted; payout_applied remains false", fixtureScenario: "BUST_RESTORE", destructive: true },
  { id: "floor-v3-open-close", route: "/floor", role: "floor", viewport: all, label: "Mở xác nhận đóng bàn", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "CLOSE_ORPHAN", destructive: false },
  { id: "floor-v3-close-confirm", route: "/floor", role: "floor", viewport: all, label: "Xác nhận đóng bàn trống", expectedState: "enabled", expectedBackendCall: "close_tournament_table_v3", expectedDbInvariant: "empty table session, tournament assignment and dealer assignment close atomically", fixtureScenario: "CLOSE_ORPHAN", destructive: true },
  { id: "floor-v3-open-break", route: "/floor", role: "floor", viewport: all, label: "Mở xác nhận đóng & chuyển", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: null, fixtureScenario: "CLOSE_ORPHAN", destructive: false },
  { id: "floor-v3-break-confirm", route: "/floor", role: "floor", viewport: all, label: "Xác nhận đóng & chuyển", expectedState: "enabled", expectedBackendCall: "floor_break_table_v3", expectedDbInvariant: "capacity, moves, dealer release and session close are one transaction", fixtureScenario: "CLOSE_ORPHAN", destructive: true },
