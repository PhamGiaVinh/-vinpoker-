...
export const floorButtonCoverageManifest: readonly FloorButtonCoverageEntry[] = [
  ...
  { id: "floor-v3-open-free-sit", route: "/floor", role: "floor", viewport: all, label: "Free Sit", expectedState: "navigation-only", expectedBackendCall: null, expectedDbInvariant: "entry and stack remain unchanged while the seat is released", fixtureScenario: "BUST_RESTORE", destructive: false },
  { id: "floor-v3-free-sit-confirm", route: "/floor", role: "floor", viewport: all, label: "Confirm Free Sit", expectedState: "enabled", expectedBackendCall: "floor_free_sit_player_v1", expectedDbInvariant: "entry returns to Waiting with the exact current stack and no payout", fixtureScenario: "BUST_RESTORE", destructive: true },
