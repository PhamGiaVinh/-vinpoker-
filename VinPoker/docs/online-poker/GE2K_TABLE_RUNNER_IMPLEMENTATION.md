...
- DB: `supabase/migrations/20260911000000_op_run_due_table_ticks.sql` (lister + dry-run diag)
...
- Rollback: `docs/emergency_rollbacks/PRE_GE2K_20260911000000_*_rollback.sql`
...
1. Apply migrations (controlled, single-file): `20260907000000` (GE-2I), `20260908000000` (GE-2J),
   `20260911000000` (GE-2K lister) — verify each live, flag stays OFF.
...
| **Remove the lister** | `docs/emergency_rollbacks/PRE_GE2K_20260911000000_*_rollback.sql` (DROPs both functions). |
