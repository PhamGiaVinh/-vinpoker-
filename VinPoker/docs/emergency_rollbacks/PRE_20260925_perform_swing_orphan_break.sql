-- ════════════════════════════════════════════════════════════════════════════
-- ROLLBACK snapshot for migration 20260925000000_perform_swing_orphan_break_cleanup
--
-- This is the POST-#312 body of perform_swing [oid 199044] (rollback-identity fix
-- included, BEFORE the PR3-D orphan-break cleanup). To roll back the PR3-D apply:
-- re-run this CREATE OR REPLACE — it restores the #312 state (markers restored on
-- race-lost) WITHOUT the dealer_breaks cleanup. Only roll back on a PR3-D regression;
-- doing so reinstates the orphan-open-break gap on the p_send_to_break race-lost path.
-- ════════════════════════════════════════════════════════════════════════════
