-- Live snapshot 2026-06-12 09:37 before idle-dealer fix. OID 257643.
CREATE OR REPLACE FUNCTION public.execute_pre_assigned_swing(p_assignment_id uuid, p_next_attendance_id uuid, p_send_to_break boolean DEFAULT false, p_break_duration_minutes integer DEFAULT NULL::integer, p_reason text DEFAULT 'pre_assigned_swing'::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
