-- ============================================================================
-- PRE-APPLY SNAPSHOT: execute_pre_assigned_swing
-- Captured before applying 20260817000003_fix_executor_step9_incoming_credit
-- Date: 2026-06-13
-- Purpose: rollback to this version if 20260817000003 needs to be reverted.
-- To rollback: execute this file (the CREATE OR REPLACE FUNCTION below) against the live DB.
-- SECURITY: no secrets; function body only.
-- ============================================================================
