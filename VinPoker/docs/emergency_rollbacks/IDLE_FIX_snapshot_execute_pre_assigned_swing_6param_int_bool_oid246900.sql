-- Live snapshot 2026-06-12 09:37 before idle-dealer fix. OID 246900.
CREATE OR REPLACE FUNCTION public.execute_pre_assigned_swing(p_old_assignment_id uuid, p_next_attendance_id uuid, p_swing_due_at timestamp with time zone, p_duration_minutes integer DEFAULT 30, p_break_duration_minutes integer DEFAULT 15, p_send_to_break boolean DEFAULT false)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
