-- LIVE snapshot of calculate_dealer_payroll BEFORE P0 apply (2026-06-16)
-- old md5: 59c28609f586c5f80b83a2b1ea8daf97
-- Rollback = re-run this file (it is a full CREATE OR REPLACE).
