-- ============================================================================
-- PRE_GE2K_20260911000000_op_run_due_table_ticks_rollback.sql
--
-- ROLLBACK for 20260911000000_op_run_due_table_ticks.sql.
--
...
-- DELETE FROM supabase_migrations.schema_migrations WHERE version = '20260911000000';
