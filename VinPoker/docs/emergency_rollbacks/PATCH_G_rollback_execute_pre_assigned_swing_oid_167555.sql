-- PATCH G rollback snapshot — captured 2026-06-11 BEFORE applying migration
-- 20260809000000_patch_g_fix_execute_pre_assigned_swing.sql
--
-- Target OID 167555:
--   execute_pre_assigned_swing(uuid, uuid, timestamptz, integer, boolean, integer)
--
-- To revert PATCH G: run this file via the Management API SQL executor.
-- Wrap in BEGIN; ... COMMIT; if running interactively.
