...
for (const [suit, symbol, color] of suits) {
  for (const rank of ranks) {
    writeFileSync(`${output}/${rank}${suit}.svg`, `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 140" role="img" aria-labelledby="title"><title id="title">${rank}${symbol}</title><defs><linearGradient id="light" x2="1" y2="1"><stop stop-color="#fff" stop-opacity=".12"/><stop offset="1" stop-color="#000" stop-opacity=".18"/></linearGradient></defs><rect x="1" y="1" width="98" height="138" rx="9" fill="${color}"/><rect x="1" y="1" width="98" height="138" rx="9" fill="url(#light)" stroke="#fff" stroke-opacity=".3" stroke-width="2"/><g fill="#fff" font-family="Arial, sans-serif" font-weight="700"><text x="69" y="119" text-anchor="middle" font-size="106" opacity=".09">${symbol}</text><text x="11" y="32" font-size="28">${rank}</text><text x="11" y="59" font-size="27">${symbol}</text><text x="87" y="124" text-anchor="end" font-size="70" letter-spacing="-3">${rank}</text></g></svg>\n`);
  }
}
