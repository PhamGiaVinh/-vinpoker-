...
const lastHandMigration = readFileSync(resolve(root, "supabase/migration-archive/remote-history/recovered-source/20260924070939_public_spectator_last_hand_history.sql"), "utf8");
