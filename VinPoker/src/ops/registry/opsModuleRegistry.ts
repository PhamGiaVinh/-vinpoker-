...
export const OPS_MODULE_REGISTRY = [
  ...
  },
  {
    ...
    requiredContracts: ["club_trackers", "tracker writer concurrency UAT"],
  ...
  },
  {
    ...
    requiredContracts: ["club_dealer_controls", "dealer read parity UAT"],
    sideEffectClass: "NON_MONEY_WRITE",
    defaultState: "READ_ONLY",
  },
  {
    ...
    clubCapabilityPredicate: inherited((row) =>
      row.can_fnb_cashier || row.can_fnb_server || row.can_fnb_kitchen),
    requiredContracts: ["club_fnb_staff facets", "F&B money and stock UAT"],
    sideEffectClass: "MONEY",
  ...
  },
  {
    ...
    requiredContracts: ["club_marketers", "external send UAT"],
  ...
  },
  {
    ...
    requiredContracts: ["club_chip_masters", "get_issued_chip_inventory", "chip write stale contract"],
    sideEffectClass: "DESTRUCTIVE",
    defaultState: "READ_ONLY",
  },
  {
    ...
    capabilityPredicate: anyClub(owner),
    clubCapabilityPredicate: owner,
    requiredContracts: ["get_club_finance_summary"],
  ...
  },
  {
    ...
    capabilityPredicate: anyClub(owner),
    clubCapabilityPredicate: owner,
    requiredContracts: ["Series read contracts", "Ops namespaced local state"],
    sideEffectClass: "READ",
    defaultState: "READ_ONLY",
  },
