...
type Role = "player" | "club_admin" | "super_admin" | "cashier" | "media";
...
const AdminUsers = () => {
  ...
  const load = async () => {
    setBusy(true);
    const [profsRes, rolesRes, csRes, ccRes] = await Promise.all([
