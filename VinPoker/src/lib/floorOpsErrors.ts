const FLOOR_ERROR_MESSAGES: Record<string, string> = {
  ...
  tracker_chip_state_mismatch: "Dữ liệu chip Tracker và sơ đồ bàn đang thiếu hoặc lệch nhau. Hệ thống đã dừng để tránh loại sai; hãy hoàn tất đối soát Tracker rồi tải lại.",
  tracker_table_chip_authority: "Bàn Live Tracker do Tracker quản lý chip. Không sửa chip từ Floor; hãy cập nhật trong Tracker rồi tải lại.",
  player_in_active_hand: "Người chơi đang ở một ván chưa kết thúc. Hãy chốt ván trước khi loại.",
  table_has_active_hand: "Bàn đang có ván chưa kết thúc. Hãy chốt ván trước khi đổi chế độ.",
  table_not_found: "Không tìm thấy bàn đang thao tác. Hãy tải lại sơ đồ bàn.",
  invalid_floor_control_mode: "Chế độ kiểm soát chip của bàn không hợp lệ.",
  invalid_table_control_revision: "Phiên bản chế độ bàn không hợp lệ. Hãy tải lại trước khi thử lại.",
  stale_table_control_mode: "Chế độ bàn vừa được đổi ở nơi khác. Hãy tải lại trước khi tiếp tục.",
