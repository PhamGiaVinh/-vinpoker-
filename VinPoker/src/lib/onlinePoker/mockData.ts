 ...
 * what the real public projection guarantees. Seat 6 is empty, seat 5 is sitting
 * out (carried in the view but not contesting).
 */
export function mockHand(tableId: string): PublicHandView {
  return {
    ...
    seats: [
      ...
      { seat: 3, playerId: 'me', displayName: 'Bạn',   stack: '1550', committed: '150', status: 'active', isButton: false, isToAct: false },
      { seat: 4, playerId: 'u4', displayName: 'Khoa',  stack: '980',  committed: '150', status: 'active', isButton: false, isToAct: true },
