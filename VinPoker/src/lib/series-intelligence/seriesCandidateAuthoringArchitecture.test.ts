...
const STATUS_COMPATIBILITY_MIGRATION = source("supabase/migration-archive/historical-never-replay/20270112000001_series_v_candidate_authoring_source_state_compatibility.sql");
const LIVE_REGISTRATION_COMPATIBILITY_MIGRATION = source("supabase/migration-archive/historical-never-replay/20270112000002_series_v_candidate_authoring_live_registration_compatibility.sql");
