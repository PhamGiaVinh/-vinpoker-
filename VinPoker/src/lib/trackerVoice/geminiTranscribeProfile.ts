...
export const TRACKER_VOICE_GEMINI_TRANSCRIBE_VOCABULARY = [
  ...
  "raise 120 nghìn", "raise một trăm nghìn", "raise một trăm hai mươi nghìn", "raise hai trăm nghìn", "raise năm trăm nghìn",
  "raise 1 triệu 750 nghìn", "raise 1 million and 200 thousand",
  ...
  "K bích K cơ", "9 bích 9 rô",
  "ghế 8 cầm K bích K cơ", "ghế 8 có K bích K cơ", "ghế 9 cầm Q rô Q tép",
  "flop K bích 9 cơ 5 rô", "flop năm bích bảy cơ hai tép", "turn hai rô", "river át tép",
] as const;
