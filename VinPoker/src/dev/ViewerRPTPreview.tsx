...
function ViewerRPTPreviewContent() {
  ...
  previewTables.push({ ...previewTables[0], tableId: "table-2", tableSessionId: "session-2", name: "Bàn 15", handId: "hand-28", handNumber: 28, street: "flop", board: ["AS", "TH", "7C"], pot: 3_000_000, players: previewTables[0].players.map((player, index) => ({ ...player, entryId: `other-entry-${index}`, playerId: `other-player-${index}`, name: ["HẢI", "TRANG", "PHÚC", "QUÂN", "THẢO", "ĐỨC"][index], holeCards: index === 1 ? ["8D", "8H"] : [] })) });
