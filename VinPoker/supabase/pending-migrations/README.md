...
- `20270119000001_multiday_equal_tie_entitlement_v1.sql` — internal, source-only occupied-rank sum/split for a TD-confirmed tie group. Each tied player receives the same amount rounded down to 1,000 VND; the residual is reported separately as club-retained. It cannot finalize a batch, qualify bags, record the residual in the club ledger or pay money.
