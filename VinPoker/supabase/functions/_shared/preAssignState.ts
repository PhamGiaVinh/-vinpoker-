/** Shared pre-assignment state helpers (extracted from src/lib/dealerSwingState.ts) */
...
function comparePass3Candidates(a: Pass3CandidateLike, b: Pass3CandidateLike): number {
