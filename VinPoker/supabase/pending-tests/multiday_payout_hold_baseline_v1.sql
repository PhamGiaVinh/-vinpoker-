...
CREATE TABLE public.tournament_prize_payments(id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
 tournament_id uuid NOT NULL REFERENCES public.tournaments(id),recipient_ref uuid,
...
INSERT INTO public.tournament_prize_payments(id,tournament_id,recipient_ref,status,prize_amount)
 VALUES('a2000000-0000-0000-0000-000000000001',
  '40000000-0000-0000-0000-000000000008',
  '60000000-0000-0000-0000-000000000006','paid',1000000);
INSERT INTO public.tournament_prizes(tournament_id,position,amount)
 VALUES('40000000-0000-0000-0000-00000000000b',1,1000000),
       ('40000000-0000-0000-0000-00000000000d',1,1000000);
