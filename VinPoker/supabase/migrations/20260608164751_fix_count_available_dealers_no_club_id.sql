-- Phase 5 PR #3: Fix count_available_dealers - dealer_attendance has no club_id
-- Join through dealers to get club_id
-- Also add status='checked_in' filter for consistency with Pass 0b
